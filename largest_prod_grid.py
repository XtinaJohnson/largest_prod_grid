...
def antidiagonal(table, k):
    '''antidiagonal(table, k) -> Gets the kth "antidiagonal" for the given
...
if __name__ == '__main__':
    ...
    print('The largest product of four adjacent numbers in the table is %i.' %all_products[(len(all_products) - 1)])
